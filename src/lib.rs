...
/// | 5 = 10            | Pair              | ?                                     |
/// | 5..10             | Range             | ?                                     |
/// | 5 <> 10           | Concatenation     | Vec<T>                                |
/// | list ~ 1..3       | Slice             | Vec<T>                                |
/// | 10, 20, 30        | List              | List, Map, Struct, Tuple              |
/// | { 5 + 5 }         | Expression        | ?                                     |
